    ...
    >
      {[
        ...
        { label:    'lateeral deltoid',
          position: '-1.1m 3.1m -0.1749m',
          normal:   '-1.1m 3.05m -0.1749m',
          orbit:    '-67deg 55deg 0.06213665m',
          target:   '1.9m 1.1m -1.1m' },

        { label:    'anterior deltoid',
          position: '-1.1m 3.3m -0.1749m',
          normal:   '-1.1m 3.3m -0.1749m',
          orbit:    '-48deg 55deg 0.06213665m',
          target:   '1.8m 0.9m -1.8m' },

        { label:    'trapezius',
          position: '0.9m 3.2m -0.0749m',
          normal:   '0.9m 3.2m -0.0749m',
          orbit:    '-180deg 50deg 0.07090651m',
          target:   '0m 1.3m 1.9m' },
        { label: 'latissimus',
          position: '0.9m 3m -0.0749m',
